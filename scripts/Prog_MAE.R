...
load("C:/ICB_Hsu/data/output/Gencode.v19.annotation.RData")
...
dat <- get_MultiAssayExp(study = "Hsu", output_dir, expr_with_counts_isoforms=FALSE)
saveRDS(dat, file=file.path(output_dir, "ICB_Hsu.rds"))
